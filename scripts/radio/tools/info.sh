#!/bin/bash
#=============================================================================
# InfraStack Radio Module - Info Tool
...
#
# This script displays detailed information about radio containers
#=============================================================================
...
# Purpose: Display summary of entire radio system
show_system_summary() {
    init_inventory

    echo ""
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    log_info "Radio Module System Summary"
    echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
    echo ""
    ...
    if [[ $total -gt 0 ]]; then
        ...
        tail -n +2 "$INVENTORY_FILE" 2>/dev/null | while IFS=',' read -r ctid rest; do
            ...
            if [[ "$status" == "running" ]]; then
                echo "running" >> /tmp/infrastack_status_count
            elif [[ "$status" == "stopped" ]]; then
                echo "stopped" >> /tmp/infrastack_status_count
            fi
        done

        if [[ -f /tmp/infrastack_status_count ]]; then
            running=$(grep -c "running" /tmp/infrastack_status_count 2>/dev/null || echo "0")
            stopped=$(grep -c "stopped" /tmp/infrastack_status_count 2>/dev/null || echo "0")
            rm /tmp/infrastack_status_count
        fi
