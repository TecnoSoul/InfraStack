#!/bin/bash
#=============================================================================
# InfraStack Radio Module - Update Tool
...
#
# This script handles updates for radio containers
#=============================================================================
...
# Purpose: Update all radio containers regardless of platform
update_all_containers() {
    ...
    log_info "Updating all radio containers ($total_count total)..."
    echo ""
...
Examples:
    ...
    infrastack radio update --platform azuracast
